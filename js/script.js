...
function openQuestion(questionEl)
{
    ...
    var answerButtonsInputContainerEl = document.createElement('div');
    ...
    var answerPictureBtn = document.createElement('button');
        ...
        answerPictureBtn.innerHTML = '<img src="img/picture-icon.png">';
    var answerLinkBtn = document.createElement('button');
        answerLinkBtn.className = 'input';
        answerLinkBtn.innerHTML = '<img src="img/link-icon.png">';
    ...
    answerButtonsInputContainerEl.appendChild(answerBoldBtn);
    answerButtonsInputContainerEl.appendChild(answerPictureBtn);
    answerButtonsInputContainerEl.appendChild(answerLinkBtn);
    answerButtonsEl.appendChild(answerButtonsInputContainerEl);
